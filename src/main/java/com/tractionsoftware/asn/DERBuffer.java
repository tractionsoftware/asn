...
/*
 * This source file was slightly modified from the original.
 */
...
/**
 * DER Buffer Class: Pack/unpack objects from a ASN.1 DER encoded blob.
 *
 * @author gkspencer
 */
public class DERBuffer {

    private static final Logger LOGGER = Logger.getLogger(DERBuffer.class.getName());
     ...
     * @return DERObject
     * @throws IOException
     *     if the format of the data is invalid or unsupported.
     */
    public final DERObject unpackObject() throws IOException {
        ...
        if ((objTyp & DER.Application) != 0) {
            ...
            LOGGER.log(
                Level.FINE,
                "DER unpackObject typ=Applicationspecific objTyp=0x" + Integer.toHexString(objTyp)
            );
        }
        else {
            ...
            LOGGER.log(
                ...
                DER.isTypeString(DER.isType(objTyp)) +
                " objTyp=0x" +
     ...
     *     List
     */
    public final void packApplicationSpecific(List<? extends DERObject> derList) throws IOException {
     ...
     *     List
     */
    public final void packApplicationSpecific(int tagId, List<? extends DERObject> derList) throws IOException {
        ...
        if (derList != null && !derList.isEmpty()) {
            ...
            for (DERObject derObject : derList) {
                // Pack the current object
                derBuf.packObject(derObject);
            }
